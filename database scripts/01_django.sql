...
ALTER COLUMN "CHFID" TYPE VARCHAR(50);
...
--
-- TOC entry XXXX (class 2607 OID XXXXX)
-- Name: uspUpdateClaimFromPhone; Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER TABLE "public"."tblClaim" 
    ALTER COLUMN "ClaimUUID" SET DEFAULT uuid_generate_v4(),
    ALTER COLUMN "ValidityFrom" SET DEFAULT NOW();
